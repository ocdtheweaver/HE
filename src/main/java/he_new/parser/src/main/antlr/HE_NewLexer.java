...
public class HE_NewLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SUMMON", "WITH", "NAMED", "AS", "MAKE", "LIKE", "HAS", "CAN", "ON", 
			"IS", "PRINT", "TELL", "TO", "SHOW", "CENTERED", "WAIT", "SECONDS", "AND", 
			"IMAGE", "SOUND", "MUSIC", "VIDEO", "FONT", "SHADER", "STRING_TYPE", 
	...
	public HE_NewLexer(CharStream input) {
		super(input);
