# Backup old visitor
Copy-Item "src\main\kotlin\visitor\AstVisitor.kt" "src\main\kotlin\visitor\AstVisitor.kt.backup" -Force

# Create fixed visitor
$newVisitor = @'
package visitor
...
$newVisitor | Out-File -FilePath "src\main\kotlin\visitor\AstVisitor.kt" -Encoding UTF8

Write-Host "Updated AstVisitor.kt for new grammar"
Write-Host "Now run: .\compile.bat"